...
assignees: [JYRRC, ryzenforce990, Kizziama]
---
...
## Did you properly read [Device stability requirements](https://github.com/HorizonDroidLab/official_devices/blob/14/requirements.md) and [Maintainer requirements](https://github.com/HorizonDroidLab/official_devices/blob/14/maintainerreq.md) before applying? What part of those requirements do you violate?
```
